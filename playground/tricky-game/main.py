...
def init_game():
    ...
    print("Welcome to the Tricky game. Player 1: {player1}, & Player 2: {player2} will face each other."
        .format(player1 = player1.name, player2 = player2.name))
    print("""To play you will use the board below as a reference. At each turn you will be asked for your move, 
